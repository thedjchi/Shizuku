...
object ShizukuReceiverStarter {
    ...
    fun buildNotification(
        ...
        return nb
            ...
            .setOngoing(true)
            .setSilent(true)
            .addAction(R.drawable.ic_server_restart, context.getString(R.string.start_background_attempt_now), attemptNowPendingIntent)
    ...
    private fun showPermissionErrorNotification(context: Context) {
        ...
        val webpageIntent =
            Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/thedjchi/Shizuku/wiki#shizuku-isnt-starting-on-boot-for-me"))
